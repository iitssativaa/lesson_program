  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          onClick={onOpenModal}
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-cyan-500 text-slate-950 font-semibold hover:bg-cyan-400 transition shadow-sm"
        >
          <Plus size={20} />
      ...
      {schedules.length === 0 ? (
        <div className="mt-8 bg-white rounded-2xl border border-dashed border-slate-300 p-6 sm:p-12 text-center">
          ...
          <button
            onClick={onOpenModal}
            className="mt-6 w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-cyan-500 text-slate-950 font-semibold hover:bg-cyan-400 transition"
          >
            <Plus size={20} />
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
          {schedules.map((schedule) => (
            <div
              ...
              className="bg-white rounded-2xl border border-slate-200 p-5 sm:p-6 shadow-sm hover:shadow-md hover:-translate-y-1 transition cursor-pointer"
            >
              ...
              <h3 className="mt-5 text-lg sm:text-xl font-bold text-slate-900 break-words">
                {schedule.name}
              </h3>
